...
public class pacienteDAO {
    ...
    public void insertar(Paciente p) {
        String sql = "INSERT INTO pacientes (id, nombre, edad, sexo, tipo_sangre, alergias, diagnostico) VALUES (?, ?, ?, ?, ?, ?, ?)";
        ...
        try (Connection conn = conexion.obtenerConexion();
            ...
            stmt.setString(5, p.getTipoSangre());
            stmt.setString(6, p.getAlergias());
            stmt.setString(7, p.getDiagnostico());
            stmt.executeUpdate();
